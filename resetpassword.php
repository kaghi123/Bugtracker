...
if(isset($_POST['submit'])){
    ...
    if(strlen($password) < 6){
        ...
        $insert = $mysqli->query("UPDATE users SET password = '$password' WHERE email = '$email'");
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Please enter a new password!</p>
                  </div>
                  <form method="POST" class="user">
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" aria-describedby="passwordHelp" placeholder="Enter A New Password..." name="password">
                    </div>
                      <div class="form-group">
