...
if(isset($_POST['submit'])){
    ...
    $mysqli = NEW MySQLi('localhost', 'georgeka_user', 'theteng1098', 'georgeka_bugTracker');
        ...
        $insert = $mysqli->query("INSERT INTO projects (name, project_manager, description, status) VALUES ('$name', '$manager', '$description', '$status')");
...
<head>
  ...
  <title>Bug Tracker - Add Project</title>
...
<!--                <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">-->
    ...
    <!-- fix this, change to display project managers -->
<!--
...
-->
    ...
    <!-- fix this, change to add developers to seperate list -->
                <option value="0">Add Developers</option>
                <?php foreach($categories as $category): ?>
                <option value="<?php echo $category->id; ?>"><?php echo $category->name; ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div  class="form-group">
            ...
            <select class="form-control" name="status">
                ...
                <option>Planning / Predevelopment</option>
                <option>Team building</option>
                <option>Development</option>
                <option>Testing and Development</option>
