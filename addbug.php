...
if(isset($_POST['submit'])){
    ...
    // image file directory
  	$target = "images/".basename($screenshot);
    
 
    //fix assigned to, must get developer id
        
    //insert project into the database
    $insert = $mysqli->query("INSERT INTO bug (title, project, status, comments, type, priority, screenshot, deadline, developer_id) VALUES ('$name', '$project', '$status', '$comments', '$type', '$priority', '$screenshot', '$deadline', '5')");
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseP" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="allprojects.php">All Projects</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseB" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="allbugs.php">All Bugs</a>
            <a class="collapse-item" href="mybugs.php">My Bugs</a>
            <a class="collapse-item" href="addbug.php">Add Bug</a>
          </div>
        </div>
      </li>
...
<!--                <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">-->
    ...
    <!-- fix this, change to display projects -->
<!--
...
-->
        ...
        <div  class="form-group">
            ...
            <select class="form-control" name="type">
                ...
                <option>"Add more of these"</option>
            </select>
        </div>
                <div  class="form-group">
    ...
    <!-- fix this, change to display all developers value is developer id-->
<!--
                <option value="0">Choose Project</option>
                <?php //foreach($categories as $category): ?>
                <option value="<?php //echo $category->id; ?>"><?php //echo $category->name; ?></option>
