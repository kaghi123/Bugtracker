...
if(isset($_POST['submit'])){
    ...
    if(!mysqli_num_rows($results) == ""){
        ...
        $insert = $mysqli->query("INSERT INTO users (first_name, last_name, email, password, type, vkey) VALUES ('$fname', '$lname', '$email', 'temp', 'Developer', '$vkey')");
        ...
        if($insert){
            ...
            $message = "<a href='http://georgekassar.offyoucode.co.uk/BugTracker/developVerify.php?vkey=$vkey&email=$email'>Register Account and Add Password</a>";
            ...
            $message = "This user will get an email!";
...
<head>
  ...
  <title>Bug Tracker - Add User</title>
